...
<img src="img/figure3.png" width="500px"/>


The barplots are similar but no exactly the same. I believe this is because some points they used were removed from the published dataset, as the sample sizes they metion aren't the same as the ones in the dataset, so some data is missing.
